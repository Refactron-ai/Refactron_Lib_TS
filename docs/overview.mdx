...
The verification surfaces are unreleased on npm today; build from source and `login` first (both are in the [quickstart](/quickstart); an unauthenticated run exits `7`):
...
The published `refactron@0.2.4` on npm is this transform CLI (`analyze`, `run`, `document`). See [Migration mode](/transforms/index) for the catalog.

## Next steps

<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/quickstart">
    Build from source and verify your first diff end to end.
  </Card>
