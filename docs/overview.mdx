...
title: Overview
icon: house
description: Prove that any change, your AI agent's, a codemod's, or your own, preserves the behavior your tests check, or find out it can't be proven. Refactron runs your real tests in an isolated shadow tree and returns a reproducible SAFE, UNSAFE, or UNPROVEN verdict.
---
