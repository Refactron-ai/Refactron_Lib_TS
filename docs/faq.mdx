...
[Migration mode](/transforms/index) is the one path that writes, and it writes only on green, atomically: either every file in the change lands or none does. See the [safety model](/concepts/safety-model#atomic-batch-write-landing).
