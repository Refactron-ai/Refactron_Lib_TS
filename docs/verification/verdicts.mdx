...
| ------------- | ---------------------- | ---------- | ----------------------------------------------------------------------- |
| A gate failed | —                      | `UNSAFE`   | The failing gate's blocking reason.                                     |
...
Every gate passed, and at least one changed line in every changed file was executed by your test suite. The change is on a tested path, and that path is green. This is the only verdict that clears a change without a caveat.
