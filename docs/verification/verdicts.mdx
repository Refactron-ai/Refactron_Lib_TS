...
<Note>
  **What this check can and cannot see.** Refactron reads the command string,
  the environment, and your pytest configuration. It recognises `pytest`,
  `unittest`, `vitest` and `jest` and
