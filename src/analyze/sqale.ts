...
export const REMEDIATION_MINUTES_BY_TRANSFORM: Record<TransformId, number> = {
  ...
  // v0.2.3 — both are mechanical one-line edits in the conservative form
  ...
  // v0.2.3 Phase 3 — mechanical one-line edits; review pass dominates the cost.
  datetime_utc_alias: 1,
  yield_from_for_loop: 1,
  // v0.2.3 Phase 4 — TS idiom rewrites. indexOf→includes and Object.assign→spread
  ...
  // v0.2.3 Phase 5 — Vue 2 reactivity helper rewrites are mechanical one-line
