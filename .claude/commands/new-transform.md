---
description: Scaffold a new Refactron transform end-to-end, in lockstep so nothing drifts: detector, sidecar (Python) or implementation (TypeScript), v2-adapter entries, tests, and mdx docs.
---
